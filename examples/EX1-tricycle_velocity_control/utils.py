...
joint_indices = {'steering':0, 'front_wheel': 1, 'left_wheel': 2, 'right_wheel': 3}
wheel_radius = 0.05
tricycle_length = 0.325
tricycle_width = 2*0.1
...
def get_robot_velocity(pb_client, robot_id, link_index=0):
    # linkWorldPosition, linkWorldOrientation, localInertialFramePosition, localInertialFrameOrientation, worldLinkFramePosition, worldLinkFrameOrientation, worldLinkLinearVelocity, worldLinkAngularVelocity = pb_client.getLinkState(bodyUniqueId=robot_id, linkIndex=link_index, computeLinkVelocity=1)

    # return worldLinkLinearVelocity, worldLinkAngularVelocity
